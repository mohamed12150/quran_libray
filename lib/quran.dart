...
import 'dart:isolate';
import 'dart:math' as math show max, pi, cos, sin, Random;
...
import 'src/service/quran_api_service.dart';
...
part 'src/pages/quran_home_screen.dart';
...
part 'src/pages/duaa_screen.dart';
part 'src/pages/qiblah_screen.dart';
part 'src/pages/prayer_times_screen.dart';
part 'src/service/azan_service.dart';
part 'src/service/dhikr_reminder_service.dart';
part 'src/pages/dhikr_reminder_screen.dart';
part 'src/hadith/models/hadith_model.dart';
part 'src/hadith/service/hadith_service.dart';
part 'src/pages/hadith_screen.dart';
